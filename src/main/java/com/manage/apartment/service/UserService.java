...
public class UserService implements ManageMyApartmentConstants {
    ...
    public List<ResidentUsers> findByEmailAddrOrFlatNumberAndAdditionalUserDetails_IsActive (String emailAddress,
                                                                                             int flatNumber){
        return userRepository.findByEmailAddrOrFlatNumberAndAdditionalUserDetails_IsActive(emailAddress,
                flatNumber, Boolean.TRUE);
    }
    ...
    public ModelAndView callGetAllUsers(ResidentUsers userSessObj){
